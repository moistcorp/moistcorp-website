    ...
    <div className="footer-top">
      ...
      <div className="footer-col">
        ...
        <div className="social-links">
          <a href="https://instagram.com/moist.corp" target="_blank" rel="noopener noreferrer">Instagram</a>
          <a href="https://linkedin.com/company/moist-corp" target="_blank" rel="noopener noreferrer">LinkedIn</a>
        </div>
      </div>
